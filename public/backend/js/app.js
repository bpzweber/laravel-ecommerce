  ...
  methods: {
    loadValues: function loadValues() {
      ...
      axios.post('/admin/attributes/get-values', {
        ...
        return _this.values = response.data;
    ...
    saveValue: function saveValue() {
      ...
      if (this.value === '') {
        ...
        axios.post('/admin/attributes/add-values', {
          ...
          _this2.values.push(response.data);

          _this2.resetValue();

          _this2.$swal("Success! Value added successfully!", {
            icon: "success"
          });
        })["catch"](function (error) {
          return console.log(error);
    ...
    updateValue: function updateValue() {
      ...
      if (this.value === '') {
        ...
        axios.post('/admin/attributes/update-values', {
          ...
          _this3.values.splice(_this3.key, 1);

          _this3.resetValue();

          _this3.values.push(response.data);

          _this3.$swal("Success! Value updated successfully!", {
            icon: "success"
          });
        })["catch"](function (error) {
          return console.log(error);
    ...
    deleteAttributeValue: function deleteAttributeValue(value) {
      ...
      this.$swal({
        ...
        if (willDelete) {
          _this4.currentId = value.id;
          _this4.key = _this4.values.indexOf(value);
          axios.post('/admin/attributes/delete-values', {
            id: _this4.currentId
          }).then(function (response) {
            if (response.data.status === 'success') {
              _this4.values.splice(_this4.key, 1);

              _this4.resetValue();

              _this4.$swal("Success! Attribute value has been deleted!", {
                icon: "success"
              });
            } else {
              _this4.$swal("Your attribute value not deleted!");
            }
          })["catch"](function (error) {
            return console.log(error);
          });
        } else {
          _this4.$swal("Your option value not deleted!");
        }
      });
    },
...
module.exports = __webpack_require__(/*! D:\laravel-projects\laravel-ecommerce\resources\js\app.js */"./resources/js/app.js");
